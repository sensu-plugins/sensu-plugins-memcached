...
Gem::Specification.new do |s|
  ...
  s.description            = 'Sensu plugins for working with memcached'
  ...
  s.name                   = 'sensu-plugins-memchached'
  s.platform               = Gem::Platform::RUBY
  s.post_install_message   = 'You can use the embedded Ruby by setting EMBEDDED_RUBY=true in /etc/default/sensu'
  s.require_paths          = ['lib']
  s.required_ruby_version  = '>= 1.9.3'
  s.signing_key            = File.expand_path(pvt_key) if $PROGRAM_NAME =~ /gem\z/
  s.summary                = 'Sensu plugins for working with memcached'
  s.test_files             = s.files.grep(%r{^(test|spec|features)/})
  s.version                = SensuPluginsMemcached::Version::VER_STRING

  s.add_runtime_dependency 'sensu-plugin', '1.1.0'
  s.add_runtime_dependency 'timeout',      '1.0.0'
